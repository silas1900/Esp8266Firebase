...
(function(){
  ...
  var config = {   // Substitua pelos seus dados do firebase4
    apiKey: "AIzaSyDLeMJgMLk53lBhAo_yDwPwcwryshcP-fY",
    authDomain: "esp8266iot-91cc9.firebaseapp.com",
    databaseURL: "https://esp8266iot-91cc9.firebaseio.com",
    storageBucket: "esp8266iot-91cc9.appspot.com",
    messagingSenderId: "127527358735"
  };
  ...
  lumiRef.on('value', onNewData('currentLumi', 'lumiLineChart' , 'Luminosidade', '%'));
